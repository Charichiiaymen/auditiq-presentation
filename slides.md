...
# PLIM — Classification d'intention

<div v-click style="display: inline-flex; align-items: center; gap: 0.55rem; font-size: 0.62rem; color: var(--aiq-text-mute); margin-top: -0.6rem; margin-bottom: 0.15rem; letter-spacing: 0.04em;">
<span style="color: var(--aiq-accent); font-weight: 700;">←</span>
<span>Suite de <em style="color: var(--aiq-glow); font-style: normal; font-weight: 600;">Cognitive Engine</em> — zoom sur le classificateur PLIM</span>
</div>

<p class="aiq-subtitle mb-3" style="font-size: 0.95rem; margin-top: -0.1rem; margin-bottom: 0.35rem;">Comment AuditIQ classe une requête marocaine — lexiques multilingues</p>

<div style="transform: scale(0.80); transform-origin: top center; margin-top: -0.3rem; margin-bottom: -1.1rem;">

<div v-click style="margin-bottom: 0.5rem;">
  <span class="aiq-chip aiq-chip-cyan">PLIM · §3.3.3</span>
  <span class="aiq-chip" style="margin-left: 0.4rem;">4 intentions</span>
  <span class="aiq-chip aiq-chip-green" style="margin-left: 0.4rem;">FR · AR · EN</span>
  <span class="aiq-chip aiq-chip-amber" style="margin-left: 0.4rem;">seuil τ = 0,3</span>
</div>

<div v-click class="aiq-meta" style="font-size: 0.78rem; margin-bottom: 0.4rem; display: flex; align-items: center; gap: 0.5rem;">
  <span style="font-weight: 600; letter-spacing: 0.05em; text-transform: uppercase; color: var(--aiq-glow);">Entonnoir d'intention</span>
  <span style="flex: 1; height: 1px; background: linear-gradient(90deg, var(--aiq-accent), var(--aiq-success), var(--aiq-warning));"></span>
  <span style="color: var(--aiq-text-mute); font-style: italic;">large → étroite · apprentissage → transaction</span>
</div>

</div>

<div class="aiq-intent-table" style="display: grid; grid-template-columns: 1.1fr 1.6fr 1.6fr 1.4fr; gap: 0; border: 1px solid var(--aiq-border); border-radius: 12px; overflow: hidden; background: linear-gradient(160deg, rgba(99, 102, 241, 0.04), rgba(139, 92, 246, 0.02)); transform: scale(0.66); transform-origin: top center; margin-bottom: -7.5rem;">

<div style="padding: 0.55rem 0.85rem; background: rgba(99, 102, 241, 0.12); color: var(--aiq-glow); font-size: 0.68rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.08em; border-bottom: 1px solid var(--aiq-border);">Intention</div>
<div style="padding: 0.55rem 0.85rem; background: rgba(99, 102, 241, 0.12); color: var(--aiq-glow); font-size: 0.68rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.08em; border-bottom: 1px solid var(--aiq-border);">Lexique FR</div>
<div style="padding: 0.55rem 0.85rem; background: rgba(99, 102, 241, 0.12); color: var(--aiq-glow); font-size: 0.68rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.08em; border-bottom: 1px solid var(--aiq-border);">Exemple FR</div>
<div style="padding: 0.55rem 0.85rem; background: rgba(99, 102, 241, 0.12); color: var(--aiq-glow); font-size: 0.68rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.08em; border-bottom: 1px solid var(--aiq-border);">Lexique AR</div>

<div v-click style="padding: 0.7rem 0.85rem; border-bottom: 1px solid rgba(99, 102, 241, 0.10); border-left: 4px solid #06b6d4; display: flex; flex-direction: column; gap: 0.15rem;">
<span style="font-weight: 700; color: var(--aiq-text); font-size: 0.95rem;">TOFU</span>
<span style="font-size: 0.7rem; color: #67e8f9; text-transform: uppercase; letter-spacing: 0.05em;">info · haut de l'entonnoir</span>
</div>
<div v-click style="padding: 0.7rem 0.85rem; border-bottom: 1px solid rgba(99, 102, 241, 0.10); font-size: 0.88rem; color: var(--aiq-text);">comment, guide, pourquoi</div>
<div v-click style="padding: 0.7rem 0.85rem; border-bottom: 1px solid rgba(99, 102, 241, 0.10); font-size: 0.88rem; color: var(--aiq-text-mute); font-style: italic;">"qu'est-ce que le SEO"</div>
<div v-click style="padding: 0.7rem 0.85rem; border-bottom: 1px solid rgba(99, 102, 241, 0.10); font-size: 0.88rem; color: var(--aiq-text); font-family: 'JetBrains Mono', monospace; direction: rtl; text-align: left;">كيف · دليل · لماذا</div>

<div v-click style="padding: 0.7rem 0.85rem; border-bottom: 1px solid rgba(99, 102, 241, 0.10); border-left: 4px solid #06b6d4; display: flex; flex-direction: column; gap: 0.15rem;">
<span style="font-weight: 700; color: var(--aiq-text); font-size: 0.95rem;">MOFU</span>
<span style="font-size: 0.7rem; color: #67e8f9; text-transform: uppercase; letter-spacing: 0.05em;">commercial · milieu de l'entonnoir</span>
</div>
<div v-click style="padding: 0.7rem 0.85rem; border-bottom: 1px solid rgba(99, 102, 241, 0.10); font-size: 0.88rem; color: var(--aiq-text);">avis, comparatif, meilleur</div>
<div v-click style="padding: 0.7rem 0.85rem; border-bottom: 1px solid rgba(99, 102, 241, 0.10); font-size: 0.88rem; color: var(--aiq-text-mute); font-style: italic;">"meilleur outil audit SEO Maroc"</div>
<div v-click style="padding: 0.7rem 0.85rem; border-bottom: 1px solid rgba(99, 102, 241, 0.10); font-size: 0.88rem; color: var(--aiq-text); font-family: 'JetBrains Mono', monospace; direction: rtl; text-align: left;">مراجعة · مقارنة · أفضل</div>

<div v-click style="padding: 0.7rem 0.85rem; border-bottom: 1px solid rgba(99, 102, 241, 0.10); border-left: 4px solid #22c55e; display: flex; flex-direction: column; gap: 0.15rem;">
<span style="font-weight: 700; color: var(--aiq-text); font-size: 0.95rem;">BOFU</span>
<span style="font-size: 0.7rem; color: #86efac; text-transform: uppercase; letter-spacing: 0.05em;">transaction · bas de l'entonnoir</span>
</div>
<div v-click style="padding: 0.7rem 0.85rem; border-bottom: 1px solid rgba(99, 102, 241, 0.10); font-size: 0.88rem; color: var(--aiq-text);">acheter, prix, commander</div>
<div v-click style="padding: 0.7rem 0.85rem; border-bottom: 1px solid rgba(99, 102, 241, 0.10); font-size: 0.88rem; color: var(--aiq-text-mute); font-style: italic;">"tarif audit SEO PME Casablanca"</div>
<div v-click style="padding: 0.7rem 0.85rem; border-bottom: 1px solid rgba(99, 102, 241, 0.10); font-size: 0.88rem; color: var(--aiq-text); font-family: 'JetBrains Mono', monospace; direction: rtl; text-align: left;">شراء · سعر · طلب</div>

<div v-click style="padding: 0.7rem 0.85rem; border-left: 4px solid #f59e0b; display: flex; flex-direction: column; gap: 0.15rem;">
<span style="font-weight: 700; color: var(--aiq-text); font-size: 0.95rem;">Nav.</span>
<span style="font-size: 0.7rem; color: #fcd34d; text-transform: uppercase; letter-spacing: 0.05em;">navigation · hors entonnoir</span>
</div>
<div v-click style="padding: 0.7rem 0.85rem; font-size: 0.88rem; color: var(--aiq-text);">(explicite — marque ou URL)</div>
<div v-click style="padding: 0.7rem 0.85rem; font-size: 0.88rem; color: var(--aiq-text-mute); font-style: italic;">"AuditIQ login"</div>
<div v-click style="padding: 0.7rem 0.85rem; font-size: 0.88rem; color: var(--aiq-text-mute);">—</div>

</div>

<div v-click style="margin-top: 0.2rem; display: flex; align-items: stretch; gap: 0.85rem; padding: 0.85rem 1.1rem; background: linear-gradient(135deg, rgba(245, 158, 11, 0.10), rgba(239, 68, 68, 0.05)); border: 1px solid rgba(245, 158, 11, 0.35); border-left: 4px solid var(--aiq-warning); border-radius: 10px;">

<div style="display: flex; align-items: center; font-size: 1.5rem; color: var(--aiq-warning); user-select: none;">⚠</div>

<div style="flex: 1; display: flex; flex-direction: column; gap: 0.2rem;">
<span style="font-weight: 700; color: var(--aiq-text); font-size: 0.92rem; letter-spacing: 0.02em;">Garde-fou — seuil de confiance τ = 0,3</span>
<span class="aiq-meta" style="font-size: 0.82rem; line-height: 1.45;">Si <strong style="color: var(--aiq-text);">max P(I|C) &lt; 0,3</strong>, l'intention est classée <span class="aiq-chip aiq-chip-amber" style="font-size: 0.68rem; padding: 0.1rem 0.5rem;">Indéterminée</span> et AuditIQ recommande une <strong style="color: var(--aiq-text);">analyse manuelle</strong> plutôt que de planter l'audit complet.</span>
</div>

</div>

<!--
Lexiques AR : translittérés en charabia latins (graphie latine phonétique, "arabizi") pour rester lisibles à la projection — le mémoire Tableau 3.8 (§3.3.3) affiche les glyphes arabes natifs. Direction: rtl pour que la lecture arabe se fasse de droite à gauche.

Couleurs de la bande latérale : cyan pour TOFU/MOFU (stade informationnel et commercial, audience large), green pour BOFU (stade transactionnel, audience étroite mais à forte valeur), amber pour Nav (hors entonnoir, intention utilitaire).

Seuil τ = 0,3 : explicite dans l'équation (3.12) du mémoire.

Le bloc "Garde-fou" reproduit la logique de graceful degradation d'aiRecommender.js (§3.3.1) : ne jamais laisser une classification ambigüe casser l'audit.

Ne pas afficher la formule IGD ici — elle appartient au slide Cognitive Engine précédent.
-->
